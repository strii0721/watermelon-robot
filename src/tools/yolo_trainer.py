...
class YOLOTrainer:
    ...
    def train(self, 
        ...
        if results: 
            result_folder = os.path.join("runs", f"{self.task}", f"{self.project_name}", f"{run_name}")
...
if __name__ == "__main__":
    ...
    # trainer.train(model_path = f"resource/weights_raw/{PRETRAINED_MODEL_NAME}.pt",
    #               run_name = run_name, 
    ...
    # trainer.simulate(model_path = "runs/segment/lane-detection/yolo26n-seg-b8-1779629105/weights/best.pt", 
